...
class AdmissionsTab extends StatelessWidget {
            ...
            child: Column(
              ...
              children: [
                ...
                ListView(
                  ...
                  children: [
                    _buildAdmissionItem(context, name: 'Aanya Sen', grade: 'Class 10A', email: 'aanya.sen@gmail.com', city: 'Kolkata'),
                    _buildAdmissionItem(context, name: 'Vikram Malhotra', grade: 'Class 11A', email: 'vikram.m@yahoo.com', city: 'Mumbai'),
                    _buildAdmissionItem(context, name: 'Rohan Deshmukh', grade: 'Class 10B', email: 'rohan.d@gmail.com', city: 'Pune'),
                  ],
                ),
              ],
            ),
  ...
  Widget _buildAdmissionItem(BuildContext context, {required String name, required String grade, required String email, required String city}) {
    return Container(
