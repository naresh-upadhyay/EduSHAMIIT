...
class _GateScannerTabState extends State<GateScannerTab> {
  final List<Map<String, dynamic>> _scanLogs = [
    {'time': '08:44:12 AM', 'name': 'Aditya Sen', 'role': 'Student (10A)', 'gate': 'Main Gate 1', 'status': 'Approved', 'method': 'RFID Card'},
    {'time': '08:42:05 AM', 'name': 'Nisha Goel', 'role': 'Student (12B)', 'gate': 'East Wing 2', 'status': 'Approved', 'method': 'Biometric Face ID'},
    {'time': '08:35:50 AM', 'name': 'Mr. S. K. Roy', 'role': 'Teacher', 'gate': 'Staff Entry', 'status': 'Approved', 'method': 'Fingerprint'},
    {'time': '08:30:11 AM', 'name': 'Unknown Person', 'role': 'Visitor', 'gate': 'Main Gate 1', 'status': 'Rejected', 'method': 'Unauthorized Access Attempt'},
  ];

  void _simulateScan(String name, String role, String gate, String method, bool success) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Simulated Scan: $name - ${success ? 'Access Approved' : 'Access Denied'}'),
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    ElevatedButton.icon(
                      onPressed: () => _simulateScan('Nidhi Patel', 'Student (10B)', 'Main Gate 1', 'RFID Card', true),
                    ...
                    ElevatedButton.icon(
                      onPressed: () => _simulateScan('Mr. Aniket Das', 'Teacher', 'Staff Entry', 'Fingerprint', true),
                    ...
                    const SizedBox(width: 16),
                    ElevatedButton.icon(
                      onPressed: () => _simulateScan('Intruder Check', 'Blacklisted Profile', 'Main Gate 1', 'Camera Face Scan', false),
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color: isApproved ? Colors.transparent : Colors.red.withOpacity(0.2),
                        ),
                      ),
                      child: Row(
                          ...
                          Row(
                            children: [
                              Icon(
                                ...
                                color: isApproved ? const Color(0xFF10B981) : Colors.red,
                                size: 24,
                              ),
                              const SizedBox(width: 16),
                              Column(
