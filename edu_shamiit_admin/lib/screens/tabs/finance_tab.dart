...
class FinanceTab extends StatelessWidget {
            ...
            child: Column(
              ...
              children: [
                ...
                Table(
                  ...
                  children: [
                    _buildTableHeader(),
                    _buildTableRow('TXN-4902', 'Nidhi Sharma (Roll 14, 10A)',
                        'Tuition Fees', '₹28,500', 'Success'),
                    _buildTableRow('TXN-4901', 'Rahul Verma (Roll 08, 11A)',
                        'Transport Fees', '₹4,500', 'Success'),
                    _buildTableRow('TXN-4900', 'Priya Gupta (Roll 22, 10B)',
                        'Tuition Fees', '₹28,500', 'Pending'),
                    _buildTableRow('TXN-4899', 'Amit Patel (Roll 02, 12A)',
                        'Exam Registration', '₹1,200', 'Success'),
                    _buildTableRow('TXN-4898', 'Sneha Roy (Roll 31, 9B)',
  ...
  TableRow _buildTableRow(
      String id, String sender, String category, String amount, String status) {
    final statusColor =
        status == 'Success' ? const Color(0xFF10B981) : const Color(0xFFF59E0B);
    return TableRow(
      children: [
        Padding(
        ...
        Padding(
            padding: const EdgeInsets.symmetric(vertical: 16),
            child:
                Text(sender, style: const TextStyle(color: Color(0xFFCBD5E1)))),
        Padding(
            padding: const EdgeInsets.symmetric(vertical: 16),
            child: Text(category,
