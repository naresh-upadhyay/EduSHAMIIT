...
class _RouteManagementScreenState extends ConsumerState<RouteManagementScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    // 6 tabs: Overview, Route Management, Live Tracking, Route Reports, Stops, Passenger Assignment
  ...
  Widget _buildTabContent() {
    ...
    return IndexedStack(
      ...
      children: [
        ...
        _visitedTabs.contains(2) ? _buildLiveTrackingTab() : const SizedBox.shrink(),
        _visitedTabs.contains(3) ? _buildRouteReportsTab() : const SizedBox.shrink(),
        _visitedTabs.contains(4) ? _buildStopsTab() : const SizedBox.shrink(),
        _visitedTabs.contains(5) ? _buildStudentAssignmentTab() : const SizedBox.shrink(),
      ],
    );
  }
