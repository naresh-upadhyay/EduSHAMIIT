...
class TeacherShellScaffold extends StatelessWidget {
  ...
  static const _navItems = [
    _NavItem(emoji: '🏠', label: 'Home', route: '/teacher/dashboard'),
    _NavItem(emoji: '📖', label: 'Classes', route: '/teacher/my-classes'),
    _NavItem(emoji: '📊', label: 'Grades', route: '/teacher/gradebook'),
    _NavItem(emoji: '📝', label: 'Tasks', route: '/teacher/homework'),
    _NavItem(emoji: '👤', label: 'Profile', route: '/teacher/profile'),
  ];
