...
import 'package:edu_shamiit_ai/shared/widgets/parent_bottom_nav.dart';
import 'package:edu_shamiit_ai/shared/widgets/ai_fab.dart';

/// Shell scaffold that wraps all parent screens.
...
class ParentShellScaffold extends StatelessWidget {
  ...
  const ParentShellScaffold({super.key, required this.child});
  ...
  Widget build(BuildContext context) {
    ...
    if (Responsive.isDesktop(context)) {
      ...
      return Scaffold(
        ...
        floatingActionButton: location.endsWith('/ai-chat')
            ? null
            : AiFab(
                gradient: AppGradients.parentPrimary,
                onPressed: () => context.push('/parent/ai-chat'),
              ),
      );
    }
