...
class _StudentHomeworkState extends ConsumerState<StudentHomework> {
  ...
  String _getStatusText(HomeworkAssignment hw) {
    ...
    if (hw.status == 'graded') {
      ...
      return 'Returned (Needs Correction)'.tr(ref);
  ...
  Widget build(BuildContext context) {
    ...
    final filters = [
      ...
      AzureGridFilter<HomeworkAssignment>(
        label: 'Status',
        options: ['Pending', 'Submitted', 'Graded', 'Late', 'Returned'],
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              'Download Instruction Document'.tr(ref),
                              style: TextStyle(
                                fontSize: 11,
                                fontWeight: FontWeight.w600,
