        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              _buildContactSidebarItem(Icons.email_outlined, 'support@schoolerp.com'),
              _buildContactSidebarItem(Icons.phone_outlined, '+91 98765 43210'),
              ...
              child: InkWell(
                onTap: () {
                  if (item == 'Contact Us') {
                    ...
                    context.go('/faq');
                  } else if (item == 'Help Center' || item == 'User Guides') {
