-- ============================================================================
-- Migration: 242_fix_delete_calendar_override_count.sql
-- Description: Exclude child override rows (recurring_parent_id IS NOT NULL) and
--              cancelled/declined schedules from active schedule count in fn_delete_calendar.
-- ============================================================================
...
BEGIN
    ...
    -- 4. Check active root schedule count assigned to this calendar
    -- (Excludes internal recurrence override rows with recurring_parent_id IS NOT NULL and cancelled schedules)
