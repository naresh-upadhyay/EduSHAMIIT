-- ============================================================================
-- Migration: 252_fix_override_soft_delete_recurrence_preservation.sql
-- Description:
--   1. Ensures that updating/overriding a single date occurrence ('this_event')
--      ONLY soft-deletes previous single-event override rows, and NEVER soft-deletes
--      a recurring parent or split recurring series (is_recurring = TRUE).
--   2. Ensures recurring series remain alive to generate all subsequent days (e.g. Day 12).
--   3. Excludes target date on both master parent and current split series.
-- ============================================================================
