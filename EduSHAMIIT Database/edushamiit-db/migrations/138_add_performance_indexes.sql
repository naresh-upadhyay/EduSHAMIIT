...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_messages_receiver_filtered
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_notifications_user_filtered
    ON notifications(user_id, is_read, created_at DESC);

-- Exams: filtered by school + class + subject (common search pattern)
DROP INDEX IF EXISTS idx_exams_school_class_subject;
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_exams_school_class_subject
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_live_classes_school_status_time
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_ai_chat_session
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_documents_school_folder
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_xp_transactions_student_time
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_profiles_id_school
    ON profiles(id, school_id);

-- Call sessions: student call history
DROP INDEX IF EXISTS idx_call_sessions_student;
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_call_sessions_student
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_homework_sub_student_time
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_course_progress_student
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_payments_student_time
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_attendance_school_student_date
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_notifications_school_created
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_fees_due_status
    ON fees(school_id, due_date, status);

-- Salary: teacher payment history
DROP INDEX IF EXISTS idx_salary_teacher_time;
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_salary_teacher_time
